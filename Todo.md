...
Done:
* Fix searching at different levels
* Fix sorting at different levels (might revisit, it's not 100% satisfactory, probably disable lower level sorts when we are in a higher hierarchy?)